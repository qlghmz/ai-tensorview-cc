...
const zh = {
  ...
  // --------- Publish dialog ---------
  "publish.title": "一键发布到公网",
  "publish.sub": "选择部署平台，独立链接对外可用",
  "publish.tab.edgeone": "国内 · EdgeOne",
  "publish.tab.vercel": "海外 · Vercel",
  "publish.done": "完成",
  "publish.copy": "复制链接",
  "publish.open": "打开",
  "publish.copied": "已复制",
  "publish.copyFailed": "复制失败",
  "publish.edgeone.label": "已发布的公网链接",
  "publish.edgeone.note": "链接由腾讯云 EdgeOne 提供，完全独立，跟本平台无关。",
  "publish.edgeone.slugLabel": "站内短链（带 TensorView 头部）",
  "publish.edgeone.deploy": "立即发布",
  "publish.edgeone.redeploy": "重新部署最新版本",
  "publish.edgeone.deploying": "正在发布…",
  "publish.edgeone.successToast": "发布成功，国内可直接访问",
  "publish.edgeone.noBundle": "还没有可发布的页面，先生成页面再发布",
  "publish.edgeone.intro": "点击发布后，平台会把页面打包推送到腾讯云 EdgeOne，自动给你分配一个独立的 .edgeone.app 链接。任何人打开都能直接看到成品页，不需要登录、不依赖本平台。",
  "publish.vercel.title": "部署到 Vercel（海外）",
  "publish.vercel.intro": "把成品页（以及生成的 api/* 后端接口）部署到你自己的 Vercel 账号下，拿到独立的 *.vercel.app 链接。",
  "publish.vercel.tokenLabel": "Vercel Access Token",
  "publish.vercel.tokenPlaceholder": "粘贴你的 Vercel Token，例如 vSCxxxxxx…",
  "publish.vercel.getToken": "去 Vercel 创建 Token",
  "publish.vercel.tokenHelp": "Token 仅用于把页面部署到你自己的 Vercel 账号，平台用 AES 加密保存，前端不会回显明文。",
  "publish.vercel.saveToken": "保存 Token",
  "publish.vercel.saving": "保存中…",
  "publish.vercel.saved": "Token 已保存（尾号 {tail}）",
  "publish.vercel.replace": "更换 Token",
  "publish.vercel.deploy": "发布到 Vercel",
  "publish.vercel.redeploy": "重新部署到 Vercel",
  "publish.vercel.deploying": "正在打包并部署…",
  "publish.vercel.successToast": "已部署到你的 Vercel 账号",
  "publish.vercel.urlLabel": "Vercel 部署链接",
  "publish.vercel.apiHint": "本项目包含 {n} 个 api/* 后端接口，将一并部署为 Serverless Function。",
  "publish.vercel.noToken": "请先填入 Vercel Token 再发布",
  "publish.vercel.removed": "已移除 Vercel Token",
} as const;
...
const en: Record<keyof typeof zh, string> = {
  ...
  // --------- Publish dialog ---------
  "publish.title": "One-click deploy",
  "publish.sub": "Pick a host. Get a public link instantly.",
  "publish.tab.edgeone": "China · EdgeOne",
  "publish.tab.vercel": "Global · Vercel",
  "publish.done": "Done",
  "publish.copy": "Copy link",
  "publish.open": "Open",
  "publish.copied": "Copied",
  "publish.copyFailed": "Copy failed",
  "publish.edgeone.label": "Public deployment URL",
  "publish.edgeone.note": "Hosted on Tencent EdgeOne Pages — fully independent from this platform.",
  "publish.edgeone.slugLabel": "Short link (with TensorView header)",
  "publish.edgeone.deploy": "Deploy now",
  "publish.edgeone.redeploy": "Redeploy latest version",
  "publish.edgeone.deploying": "Deploying…",
  "publish.edgeone.successToast": "Deployed. Reachable from mainland China.",
  "publish.edgeone.noBundle": "Nothing to deploy yet — generate the page first.",
  "publish.edgeone.intro": "We package your page and push it to Tencent EdgeOne Pages. You get a standalone *.edgeone.app URL anyone can open — no login, no platform lock-in.",
  "publish.vercel.title": "Deploy to Vercel (Global)",
  "publish.vercel.intro": "Ship the page (and any generated api/* serverless routes) to your own Vercel account and get a *.vercel.app URL.",
  "publish.vercel.tokenLabel": "Vercel Access Token",
  "publish.vercel.tokenPlaceholder": "Paste your Vercel token, e.g. vSCxxxxxx…",
  "publish.vercel.getToken": "Create token on Vercel",
  "publish.vercel.tokenHelp": "The token only deploys to your own Vercel account. We store it AES-encrypted and never echo the plaintext back to the browser.",
  "publish.vercel.saveToken": "Save token",
  "publish.vercel.saving": "Saving…",
  "publish.vercel.saved": "Token saved (ends with {tail})",
  "publish.vercel.replace": "Replace token",
  "publish.vercel.deploy": "Deploy to Vercel",
  "publish.vercel.redeploy": "Redeploy to Vercel",
  "publish.vercel.deploying": "Packaging and deploying…",
  "publish.vercel.successToast": "Deployed to your Vercel account",
  "publish.vercel.urlLabel": "Vercel deployment URL",
  "publish.vercel.apiHint": "Project contains {n} api/* route(s) — they'll deploy as serverless functions.",
  "publish.vercel.noToken": "Add a Vercel token first.",
  "publish.vercel.removed": "Vercel token removed",
};
