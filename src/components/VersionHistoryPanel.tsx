...
export function VersionHistoryPanel({ projectId, open, onClose, onRestored, currentBundle }: Props) {
  ...
  return (
    <>
            ...
            <div className="px-5 py-4 border-b border-border/40 flex items-center gap-2">
              ...
              {rows.length > 0 && (
                <button
                  ...
                  className="text-xs rounded-lg glass px-2 py-1 flex items-center gap-1"
                >
      ...
      <VersionDiffPanel open={diffOpen} onClose={() => setDiffOpen(false)} versions={rows} currentBundle={currentBundle} />
    </>
  );
}
